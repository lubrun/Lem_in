...
/*   Updated: 2019/12/09 11:03:56 by qbarrier    ###    #+. /#+    ###.fr     */
/*                                                         /                  */
/*                                                        /                   */
/* ************************************************************************** */
...
//			link.from->perfum[path->id_from_start]++;
//			printf("NAME FROM[%s] IDS[%d] PERF[%d]\n", link.from->name, path->id_from_start,  link.from->perfum[path->id_from_start]);
